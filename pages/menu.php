        ...
        <div class="container-fluid"  style="background-color: rgb(74, 15, 236);">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item" style=" margin-right: 35px; margin-left: 120px; text-align: center;">
              ...
              <li class="nav-item" style=" height: 60px; margin-right: 35px;margin-left: 100px; text-align: center;">
                <a class="nav-link" style="color: black; font-size: 20px; width: 200px;" href="pages/liste_article.php">
                  <button type="button" class="btn btn-outline-light" style="width: 100%; height: 40px; ">ANNUAIRE</button>
                </a>
              </li>
            </ul>
            <form class="d-flex">
